    ...
    <Fragment>
      <nav className='main-header navbar navbar-expand navbar-dark'>
        ...
        <ul className='navbar-nav'>
          ...
          <li className='nav-item d-none d-sm-inline-block'>
            <NavLink to='/dashboard' className='nav-link'> {txt.dashboardLink} </NavLink>
          </li>
          <li className='nav-item d-none d-sm-inline-block'>
            <NavLink to='/admin' className='nav-link'> {txt.adminLink} </NavLink>
          </li>
            ...
            <div className='navbar-search-block'>
              <form className='form-inline'>
                <div className='input-group input-group-sm'>
                  <input className='form-control form-control-navbar' type='search' placeholder={txt.searchInput} aria-label='Search' />
